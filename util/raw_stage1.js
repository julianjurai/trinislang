const wiktionary = [
  ...
  "Baylena - Rolling pin",
  "Bazodee - light-headed or in shock or crazy",
  ...
  "Bobbol - illegal activity, usually in the context of corporate criminality, white-collar crime or political corruption.",
...
const cguillaumme = [
  ...
  "Cunumunu - Idiot, foolish, stupid person.",
  ...
  "Sailor band -  A mas that was played by steelbands in the 60s where it was very popular",
...
const triniinxisle = [
  "Angostura (bitters) (n): A reddish-brown, slightly bitter, aromatic, alcohol-based liquid used to flavour drinks.",
  "Back a jackass in ah horse race (phrase): Back or bet on a loser one that should have been obvious had no chance to succeed.",
  "Bad John (noun): A man willing to use violence and who likes being known as a dangerous person; a ruffian.",
  ...
  "Cobo, Cobeau: Corbeau or Coragyps atratus (Black Vulture), a large bird. A very common resident in Tridindada, not found in Tobago.   Corbeau is French for Raven.",
  ...
  "Dance top in mud (phr): Try something without chance of success; be frustrated by trying to do something in too difficult a situation.",
  ...
  "Doudou, doodoo, doux-doux (n): Sweetness; sweetie; a term of affectionate endearment, usually used to females.",
  "Douen, Duende, Douaine, Doune, Dwen, Duegne (n): A Folklore character, the spirit of a child who died before baptism.  Douens wear large hats, have backwards-pointing feet, utter a soft hooting cry, and often lead children to wander off. ",
  "Eat and wipe mouth like fowl (phr): Do something wrong, but quickly cover up the evidence.",
  ...
  "Half-Pick Duck, Harpic Duck (phr):  Not the whole story, explanation.",
  ...
  "Jouvert, Jour ouvert, Jouvert (n): The official beginning of Carnival at daybreak on the Monday preceding Ash Wednesday.",
  "Kakanade:  Gossip; idle talk, shit talk.",
  "Kakalaylay  (n): Sexually suggestive dancing. /kakalele/ (<kaka + lele dance>)",
  "Kaka-nay (n): Dirty nose; snotty nose.",
  ...
  "Kicksing (n): Not taking things seriously; fooling around and not working.",
  ...
  "Maharajin, marajhin, marajin (n): A term of address or reference for the wife of a Brahmin or Pundit. Generally used as a term of respectful address for any married woman.",
  ...
  "Mama Glo, Mama Dlo, Mama D'Leau (n):  A folklore character in the form of a beautiful woman, sometimes snake-like, with long hair and a fish-like tail who lives in rivers.",
  ...
  "Never-see-come-see  (n):  Of a person, unsophisticated and therefore excited about something ordinary.",
  "Obzocky, obsockie, obzokee, obsukky, obzoky, obzockie, upzuckie  (adj):  Unbalanced; awkward-looking; of ungraceful line or shape; of a batsman, not flowing or smooth.",
  ...
  "Papa Bois (n):  A folklore character, usually depicted as having a man's head, chest and arms, with goat-horns on the head, and the lower body of a goat or similar animal. He is the protector of animals in the forests and can change himself into animal forms to lead hunters away. ",
  ...
  "Rachifee, ratcheefi, ratchifi, rachify (n): Somethings done in a makeshift, careless, or slightly devious way; or as a result of cheating, corruptions, or trickery.",
  ...
  "Sancoch, sancoche, sancoach, sancocho, san kootch (n): A thick soup made with meat, GROUND PROVISIONS, and vegetables.",
  ...
  "Say Prunes (Phr):  Used often with a negative to describe someone who seems to be quite but turns out to be quite the opposite.",
  "Soucouyant (n): A person, usually an old woman, who sheds her skin, travels as a ball of fire and sucks people's blood, leaving a blue mark. Soucouyans, have an unnatural and indelicate propensity for casting off their skin, which they usually conceal in or under a chocolate mortar.",
  "Sprawl Off (v):  Sprawl; lie around in a relaxed manner with limbs spread out.",
  ...
  "Sweat Rice: Rice into which a woman, given to a man to make him remain faithful.  Steam rice. 'Sweat rice' was supposed to be one of the more potent aphrodisiacs employed to 'tie' men. A meal of rice, which a woman prepares when she wants to trap a man.  The woman prepares this by squatting over steaming rice, and allowing her vaginal  juices to 'sweat into the rice.'",
  "Tabanca, tabanka, tabankca, tobanca (n): A painful feeling of unrequited love, from loving someone who does not love in return, especially someone who was once a lover or spouse.",
  ...
  "Washikong, wachekong, washeekong, watchekong, watchi-kong (n):  Rubber-soled canvas shoes; sneakers; plimsolls; running shoes.",
...
const izaTrini = [
  ...
  "Bredda....slang for 'brother' or 'Breddren'",
  ...
  "Ja`litre....2 litres of any soft drink / Soda",
  "Ketch....Catch",
  ...
  "Pissin' tail....A person of no class or importance",
  "Plann-asse....To hit someone continuously with the flat part of a cutlass",
  "Playin' social....Someone who pretends to be of a higher social strata than they are",
  ...
  "Sweee-drink....soft drink/soda or a gesture nickname like babes or darling",
  "Swell up yuh face....To look angry, to pout",
...
exports.cguillaumme = cguillaumme;
exports.triniinxisle = triniinxisle;
exports.izaTrini = izaTrini;
